function accexp31user15 = importfile(filename,formatSpec ,startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   ACCEXP31USER15 = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   ACCEXP31USER15 = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   accexp31user15 = importfile('acc_exp31_user15.txt', 1, 17178);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/03/22 17:03:21
...
accexp31user15 = [dataArray{1:end-1}];
